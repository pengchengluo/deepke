...
class CNN(nn.Module):
    ...
    Args:
        cfg (): CNN 模块配置，主要包括如下设置
        in_channels (int): 输入到 CNN 的 channel 维度， 一般是 word embedding 的维度，或者是 hidden size 的维度
    ...
    def __init__(self, cfg):
        ...
        self.pooling_strategy = cfg.pooling_strategy
        self.dropout = cfg.dropout
        self.keep_length = cfg.keep_length
